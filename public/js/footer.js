document.addEventListener("DOMContentLoaded", () => {
    ...
    const redes = Utils.storage.get("redes_sociales") || [
        ...
        { nombre: "Instagram", url: "https://instagram.com/wallywear", activo: true }
    ];
    ...
    footer.innerHTML = `
        <div style="max-width: 1000px; margin: 0 auto;">
            <h2 style="margin-bottom: 1rem;">Wally Wear</h2>
            ...
            <p style="font-size: 0.8rem; color: #888;">&copy; ${new Date().getFullYear()} Wally Wear - Paraguay. Todos los derechos reservados.</p>
        </div>
    `;
